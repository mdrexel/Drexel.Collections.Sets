...
{
    public class MockImmutableSet<T> : Drexel.Collections.Immutable.IImmutableSet<T>
    {
        public MockImmutableSet()
            : this(
                  null,
                  null,
                  null,
        ...
        public MockImmutableSet(Drexel.Collections.Immutable.IImmutableSet<T> set)
            : this(
                  set.Add,
                  set.Clear,
                  set.Contains,
        ...
        public MockImmutableSet(
            Func<T, Drexel.Collections.Immutable.IImmutableSet<T>>? addDelegate,
            Func<Drexel.Collections.Immutable.IImmutableSet<T>>? clearDelegate,
            Func<T, bool>? containsDelegate,
            Func<int>? countDelegate,
            Func<object, bool>? equalsDelegate,
            Func<IEnumerable<T>, Drexel.Collections.Immutable.IImmutableSet<T>>? exceptDelegate,
            Func<IEnumerator<T>>? getEnumeratorDelegate,
            Func<int>? getHashCodeDelegate,
            Func<IEnumerable<T>, Drexel.Collections.Immutable.IImmutableSet<T>>? intersectDelegate,
            ...
            Func<T, Drexel.Collections.Immutable.IImmutableSet<T>>? removeDelegate,
            Func<IEnumerable<T>, bool>? setEqualsDelegate,
            Func<IEnumerable<T>, Drexel.Collections.Immutable.IImmutableSet<T>>? symmetricExceptDelegate,
            Func<string>? toStringDelegate,
            TryGetValueDelegateSignature? tryGetValueDelegate,
            Func<IEnumerable<T>, Drexel.Collections.Immutable.IImmutableSet<T>>? unionDelegate)
        {
        ...
        public Func<T, Drexel.Collections.Immutable.IImmutableSet<T>> AddDelegate { get; set; }

        public Func<Drexel.Collections.Immutable.IImmutableSet<T>> ClearDelegate { get; set; }
        ...
        public Func<IEnumerable<T>, Drexel.Collections.Immutable.IImmutableSet<T>> ExceptDelegate { get; set; }

        public Func<IEnumerator<T>> GetEnumeratorDelegate { get; set; }

        public Func<int> GetHashCodeDelegate { get; set; }

        public Func<IEnumerable<T>, Drexel.Collections.Immutable.IImmutableSet<T>> IntersectDelegate { get; set; }
        ...
        public Func<T, Drexel.Collections.Immutable.IImmutableSet<T>> RemoveDelegate { get; set; }

        public Func<IEnumerable<T>, bool> SetEqualsDelegate { get; set; }

        public Func<IEnumerable<T>, Drexel.Collections.Immutable.IImmutableSet<T>> SymmetricExceptDelegate { get; set; }

        public Func<string> ToStringDelegate { get; set; }

        public TryGetValueDelegateSignature TryGetValueDelegate { get; set; }

        public Func<IEnumerable<T>, Drexel.Collections.Immutable.IImmutableSet<T>> UnionDelegate { get; set; }

        public int Count => this.CountDelegate.Invoke();

        public Drexel.Collections.Immutable.IImmutableSet<T> Add(T value) => this.AddDelegate.Invoke(value);

        public Drexel.Collections.Immutable.IImmutableSet<T> Clear() => this.ClearDelegate.Invoke();
        ...
        public Drexel.Collections.Immutable.IImmutableSet<T> Except(IEnumerable<T> other) => this.ExceptDelegate.Invoke(other);
        ...
        public Drexel.Collections.Immutable.IImmutableSet<T> Intersect(IEnumerable<T> other) => this.IntersectDelegate.Invoke(other);
        ...
        public Drexel.Collections.Immutable.IImmutableSet<T> Remove(T value) => this.RemoveDelegate.Invoke(value);

        public bool SetEquals(IEnumerable<T> other) => this.SetEqualsDelegate.Invoke(other);

        public Drexel.Collections.Immutable.IImmutableSet<T> SymmetricExcept(IEnumerable<T> other) => this.SymmetricExceptDelegate.Invoke(other);
        ...
        public Drexel.Collections.Immutable.IImmutableSet<T> Union(IEnumerable<T> other) => this.UnionDelegate.Invoke(other);

        System.Collections.Immutable.IImmutableSet<T> System.Collections.Immutable.IImmutableSet<T>.Add(T value) => this.Add(value);

        System.Collections.Immutable.IImmutableSet<T> System.Collections.Immutable.IImmutableSet<T>.Clear() => this.Clear();

        System.Collections.Immutable.IImmutableSet<T> System.Collections.Immutable.IImmutableSet<T>.Except(IEnumerable<T> other) => this.Except(other);

        IEnumerator IEnumerable.GetEnumerator() => this.GetEnumerator();

        System.Collections.Immutable.IImmutableSet<T> System.Collections.Immutable.IImmutableSet<T>.Intersect(IEnumerable<T> other) => this.Intersect(other);

        System.Collections.Immutable.IImmutableSet<T> System.Collections.Immutable.IImmutableSet<T>.Remove(T value) => this.Remove(value);

        System.Collections.Immutable.IImmutableSet<T> System.Collections.Immutable.IImmutableSet<T>.SymmetricExcept(IEnumerable<T> other) => this.SymmetricExcept(other);

        System.Collections.Immutable.IImmutableSet<T> System.Collections.Immutable.IImmutableSet<T>.Union(IEnumerable<T> other) => this.Union(other);
    }
}
